    ...
    <section id="pro-shop" className="py-24 bg-[#f4efe6] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-12">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-[#e6dcc7] font-semibold">
                    {prod.brands}
                  </p>
                </div>
              ...
              <div className="pt-4 border-t border-white/10 mt-4">
                <a
                  ...
                  className="w-full inline-flex items-center justify-center gap-1.5 bg-white/10 hover:bg-[#b39364] hover:text-[#122c1d] text-white font-bold py-2.5 rounded-xl text-xs uppercase tracking-wider transition-all cursor-pointer"
                >
        ...
        <div className="glass-panel p-6 border border-[#b39364]/20 max-w-3xl mx-auto flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
          ...
          <div>
            <h5 className="font-bold text-white text-base">Paddle Demo Testing Available</h5>
