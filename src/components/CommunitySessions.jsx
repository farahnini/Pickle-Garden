...
export default function CommunitySessions() {
  return (
    ...
    <section id="open-play" className="py-24 bg-[#0c1c14] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          ...
          <h3 className="font-display font-extrabold text-3xl sm:text-4xl text-white uppercase">Open Play & Social Sessions</h3>
          <p className="text-sm text-[#e6dcc7]">No partner needed! Just show up, stack your paddle, and get playing with friendly local players.</p>
        </div>

        {/* Schedule Grid - Converted to custom translucent dark slots */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {COMMUNITY_SESSIONS.map((session, idx) => (
            <div 
              key={idx} 
              className="bg-slate-950/45 p-8 border border-[#b39364]/25 hover:border-[#b39364]/50 rounded-2xl flex flex-col justify-between group transition-all duration-300 shadow-xl"
            >
              ...
              <div className="pt-6 border-t border-white/10 mt-6">
                <a
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#b39364] via-[#c2a980] to-[#d4c2a3] hover:from-[#c2a980] hover:to-[#b39364] text-[#122c1d] font-bold py-3.5 rounded-xl text-xs uppercase tracking-wider transition-colors shadow-md cursor-pointer"
                >
        ...
        {/* Community Info Note - Converted to Translucent dark card */}
        <div className="bg-slate-950/45 p-6 border border-[#b39364]/20 rounded-2xl max-w-3xl mx-auto flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left shadow-lg">
