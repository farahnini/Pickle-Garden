          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            ...
            <div className="animate-hero-item opacity-0 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              <a
                ...
                className="flex items-center justify-center gap-2.5 bg-gradient-to-r from-[#b39364] via-[#c2a980] to-[#d4c2a3] hover:from-[#c2a980] hover:to-[#b39364] text-[#122c1d] font-black px-8 h-16 rounded-xl transition-all uppercase tracking-widest text-xs shadow-lg hover:scale-[1.02]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2.5 bg-white/10 hover:bg-white/20 text-white font-bold px-8 h-16 rounded-xl transition-all uppercase tracking-widest text-xs border border-white/20 backdrop-blur-sm"
              >
