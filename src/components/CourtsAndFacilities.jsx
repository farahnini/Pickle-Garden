...
export default function CourtsAndFacilities() {
  ...
  return (
    ...
    <section id="courts" className="py-24 bg-[#0c1c14] relative overflow-hidden">
      <div className="absolute top-0 right-0 w-80 h-80 bg-[#b39364]/5 rounded-full blur-3xl pointer-events-none"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-16">
        
        {/* About / Brand Story Section */}
        <div id="about" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center pt-8 border-t border-white/10">
          ...
          <div className="lg:col-span-7">
            <p className="text-lg text-[#e6dcc7] leading-relaxed font-light">
        ...
        {/* Facilities Amenities Grid - Converted to Premium Translucent Dark Cards */}
        <div className="space-y-8">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-xs font-bold uppercase tracking-widest text-[#b39364]">Premier Setup</span>
            <h3 className="font-display font-extrabold text-2xl sm:text-3xl text-white uppercase">Facilities & Amenities</h3>
            <p className="text-sm text-[#e6dcc7]">Every detail designed to give you a premium playing experience</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {amenities.map((item, idx) => (
              <div 
                key={idx} 
                className="bg-white/5 border border-[#b39364]/20 hover:border-[#b39364]/60 rounded-2xl p-6 transition-all group duration-300 hover:bg-white/10"
              >
                <div className="flex items-start gap-4">
                  {/* Gold Check Circle */}
                  <div className="w-8 h-8 rounded-lg bg-[#b39364]/10 text-[#b39364] flex items-center justify-center shrink-0 group-hover:bg-[#b39364] group-hover:text-[#122c1d] transition-all duration-300 border border-[#b39364]/30">
        ...
        <div className="space-y-8 pt-8">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <h3 className="font-display font-extrabold text-2xl sm:text-3xl text-white uppercase">Explore Pickle Garden</h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {GALLERY_IMAGES.map((img, idx) => (
              <div 
                ...
                className="group relative h-64 rounded-2xl overflow-hidden cursor-pointer shadow-md border border-[#b39364]/25 hover:border-[#b39364]/60 transition-all duration-300"
              >
                <img 
                  src={img.url} 
                  alt={img.caption} 
